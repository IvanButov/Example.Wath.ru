...
<a href="add_Asus.php" class="a100">Добавление товара</a>
<a href="delete_Asus.php" class="a100">Удаление товара</a>
<a href="update_Asus.php" class="a100">Изменение товара</a>	
<?
else :?>
...
$i=1; 
$result=mysql_query("SELECT * from Asus");
