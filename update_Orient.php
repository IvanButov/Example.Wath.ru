...
if(isset($date)){
	...
	if(empty($errors)){
		...
		$result1 = mysql_num_rows(mysql_query("SELECT * FROM `Orient` WHERE `id` = '$id';"));
							if($result1==1)
							{
							$sql = mysql_query("UPDATE Orient SET title='$name', price='$price', img='$img' WHERE id='$id'");
...
<a href="add_Orient.php" class="a102">Добавление товара</a>
<a href="delete_Orient.php" class="a102">Удаление товара</a>
<a href="update_Orient.php" class="a102">Изменение товара</a>
<a href="Orient.php" class="a102">Cписок товаров</a>
