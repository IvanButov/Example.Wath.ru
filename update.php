...
if(isset($date)){
	...
	if(empty($errors)){
		...
		$result1 = mysql_num_rows(mysql_query("SELECT * FROM `Apple` WHERE `id` = '$id';"));
							if($result1==1)
							{
							$sql = mysql_query("UPDATE Apple SET title='$name', price='$price', img='$img' WHERE id='$id'");
...
<a href="add.php" class="a102">Добавление товара</a>
<a href="delete.php" class="a102">Удаление товара</a>
<a href="update.php" class="a102">Изменение товара</a>
<a href="Apple.php" class="a102">Cписок товаров</a>
