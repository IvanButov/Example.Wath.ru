...
<a href="add_Huawei.php" class="a100">Добавление товара</a>
<a href="delete_Huawei.php" class="a100">Удаление товара</a>
<a href="update_Huawei.php" class="a100"> Изменение товара</a>	
<?
else :?>
...
$i=1; 
$result=mysql_query("SELECT * from Huawei");
