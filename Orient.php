...
<a href="add_Orient.php" class="a100">Добавление товара</a>
<a href="delete_Orient.php" class="a100">Удаление товара</a>
<a href="update_Orient.php" class="a100">Изменение товара</a> 	
<?
else :?>
...
$i=1; 
$result=mysql_query("SELECT * from Orient");
